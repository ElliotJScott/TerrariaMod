...
{
    internal class SpaceSnakeHead : SpaceSnake
    {
        public override string Texture => "StarSailor/NPCs/Enemies/SpaceSnake_Head";
    ...
    internal class SpaceSnakeBody : SpaceSnake
    {
        public override string Texture => "StarSailor/NPCs/Enemies/SpaceSnake_Body";
    ...
    internal class SpaceSnakeTail : SpaceSnake
    {
        public override string Texture => "StarSailor/NPCs/Enemies/SpaceSnake_Tail";
    ...
    public abstract class SpaceSnake : CustomWorm
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Space Snake Name Goes Here");
        }
        ...
        public override void Init()
        {
            minLength = 25;
            maxLength = 25;
            tailType = ModContent.NPCType<SpaceSnakeTail>();
            bodyType = ModContent.NPCType<SpaceSnakeBody>();
            headType = ModContent.NPCType<SpaceSnakeHead>();
            speed = 5.5f;
            turnSpeed = 0.045f;
        }
    }
    ...
    public abstract class CustomWorm : ModNPC
    {
        /* ai[0] = follower
		 * ai[1] = following
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    bool flag21 = false;
                    if (npc.type == NPCID.WyvernHead || true)
                    {
