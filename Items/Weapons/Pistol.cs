...
namespace StarSailor.Items.Weapons
{
    ...
    class PistolV1 : Pistol
    {
        ...
        {
            Projectile.NewProjectile(position.X, position.Y, speedX, speedY, ModContent.ProjectileType<PistolV1V2V3Bullet>(), damage, knockBack, player.whoAmI);
            return false;
        }
    }

    class PistolV2 : Pistol
    {
        public override void SetStaticDefaults()
        {
    ...
    class PistolVMax : Pistol
    {
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            Projectile.NewProjectile(position.X, position.Y, speedX, speedY, ModContent.ProjectileType<PistolVMaxBullet>(), damage, knockBack, player.whoAmI);
            return false;
        }
    }
}
